...
def parse_args():
    ...
    parser.add_argument('--architecture', type=str, default='0000')
    ...
    parser.add_argument('--num-branches', type=int, default=2) # Number of 
...
if __name__ == "__main__":
    ...
    assert len(architecture) == (2 * worker.num_nodes), "len(architecture) != 4 * worker.num_nodes"
